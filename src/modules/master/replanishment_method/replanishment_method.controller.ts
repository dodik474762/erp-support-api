...
@Controller('/api/master/replanishment-method')
export class ReplanishmentMethodController {
    constructor(private service: ReplanishmentMethodService) {}
    
      @Get('/')
      index(): any {
        return {
          statusCode: 200,
          message: 'Module Replanishment Method',
        };
      }
